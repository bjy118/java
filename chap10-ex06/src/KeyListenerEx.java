...
public class KeyListenerEx extends JFrame {
	...
	public KeyListenerEx() {
		...
		c.addKeyListener(new MyKetListener());
		...
		for (int i=0; i < keyMessage.length; i++) {
			...
			keyMessage[i].setForeground(Color.YELLOW); // 배경색을 CYAN 색으로 변경
		}
	...
	class MyKetListener extends KeyAdapter {
		public void keypressed(KeyEvent e) {
			...
			System.out.println("KeyPressed"); // 콜솔창에 메소드 이름 출력
		}
		public void keyReleased(KeyEvent e) {
			System.out.println("KeyReleased");  // 콜솔창에 메소드 이름 출력
		}
