...
<body>
		...
		if (cookies != null) {
			for (int i = 0; i < cookies.length; i++) {
				...
				if (n.equals("Shipping_shippingDate"))
					shipping_shippngDate = URLDecoder.decode((thisCookie.getValue()), "utf-8");
			}
		}
	%>
	...
	<div class="container">
	<h2 class="alert alert-dange">주문해주셔서 감사합니다.</h2>
	<p> 주문은 <% out.println(shipping_shippngDate); %>에 배송될 예정입니다!
